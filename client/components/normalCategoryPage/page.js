...
const NormalCategoryPage = () => {
  ...
  useEffect(() => {
    ...
    if (currentSubCategory !== "all")
      setCurrentFilters((prev) => prev + `type=${currentSubCategory}&`);
    if (currentColor !== "all")
      setCurrentFilters((prev) => prev + `color=${currentColor}&`);
    if (currentSize !== "all")
      setCurrentFilters((prev) => prev + `size=${currentSize}&`);
  ...
  useEffect(() => {
    console.log("Cat update : ", category);
